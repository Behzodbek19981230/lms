			...
			<div className='w-full max-w-md'>
				<Card className='shadow-elegant border-border'>
					<CardHeader className='text-center'>
						...
						<CardTitle className='text-2xl text-foreground'>Hali markaz biriktirmadi</CardTitle>
					</CardHeader>
					...
					<CardContent className='text-center space-y-6'>
						<div className='text-muted-foreground'>
							...
							<p className='mb-4'>
								Sizga hali hech qanday o'quv markazi biriktirmagan. Administrator tez orada sizni
								tegishli markazga biriktiradi.
							</p>
						</div>
						...
						<div className='space-y-4'>
							<div className='flex items-center justify-center space-x-3 p-4 bg-blue-50 rounded-lg'>
								...
								<span className='text-sm text-blue-800'>Administrator javobini kuting</span>
							</div>
						...
						<div className='pt-4 border-t space-y-4'>
							<div className='text-sm text-muted-foreground'>
								<p>Savollaringiz bo'lsa, administrator bilan bog'laning.</p>
							</div>
