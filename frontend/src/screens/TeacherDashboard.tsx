		...
		<div className='min-h-screen bg-gradient-subtle'>
			...
			<div className='p-2 md:p-6'>
								...
								{todaySchedule.map((lesson) => (
									...
									>
										<div className='flex items-center space-x-3'>
											...
											<div>
												<h4 className='text-xs md:text-base font-medium text-foreground'>
													{lesson.subject}
												</h4>
				...
				<div className='mt-8'>
					...
					{isLoading && (
						<PageLoader
							title='Panel ma’lumotlari yuklanmoqda...'
							fullscreen={false}
					...
					{subjects.length === 0 ? (
						<Card className='border-border'>
							<CardContent className='flex flex-col items-center justify-center py-12'>
								...
								<h3 className='text-xs md:text-lg font-medium text-foreground mb-2'>
									Fanlar mavjud emas
								</h3>
								<p className='text-xs md:text-base text-muted-foreground mb-4'>
									Sizga hali fanlar tayinlanmagan
								</p>
							</CardContent>
						</Card>
					) : (
							...
							{subjects.map((subject) => (
								...
								>
									<CardHeader>
										...
										<CardTitle className='text-xs md:text-lg text-card-foreground'>
											{subject.name}
										</CardTitle>
									</CardHeader>
									<CardContent>
