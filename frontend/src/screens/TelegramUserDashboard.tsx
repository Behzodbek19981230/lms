					...
					{status?.autoConnected ? (
						...
						<div className='space-y-4'>
							...
							<p className='text-gray-600'>
								Test xabarnomalari olish va Telegramda to'g'ridan-to'g'ri javob berish uchun Telegram
								hisobingizni avtomatik ulang.
							</p>
							<div className='space-y-2'>
								...
								<p className='text-sm text-gray-600'>
									Tugmani bosing → Telegram bot ochiladi →{' '}
									<code className='bg-gray-100 px-1 rounded'>/start</code> → keyin bu yerda{' '}
									<b>Yangilash</b>.
								</p>
							</div>
              ...
              /> */}
							<div className='mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg'>
								...
								<p className='text-sm text-blue-700'>
									Tizim sizning ismingiz asosida avtomatik ulanishga harakat qiladi. Agar avtomatik
									ulanish ishlamasa, o'qituvchingiz bilan bog'lanib qo'lda ulanishni so'rang.
								</p>
							</div>
						</div>
					)}
			...
			{status?.availableChannels && status.availableChannels.length > 0 && (
				<Card>
					...
					<CardContent>
						<div className='space-y-4'>
							<p className='text-sm text-gray-600'>
								Test xabarnomalari olish va sinf faoliyatlarida qatnashish uchun quyidagi kanallarga
								qo'shiling:
							</p>
								...
								{status.availableChannels.map((channel) => (
									...
									>
										...
										<div className='flex gap-2'>
											...
											>
												{connectingToChannel === channel.chatId
													? 'Ochilmoqda...'
													: 'Havolani olish'}
											</Button>
				...
				<CardContent className='space-y-4'>
					<div className='space-y-3'>
						...
						<div>
							...
							<ul className='list-disc list-inside text-sm text-gray-600 space-y-1 mt-2'>
								<li>
									Testlar e'lon qilinganda, quyidagi formatda javob bering:{' '}
