			...
			<header className='bg-gradient-to-r from-card/90 via-card to-card/90 backdrop-blur-md border-b border-border/60 p-3 sm:p-4 md:p-6 animate-fade-in'>
				<div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4'>
					<div className='animate-slide-up'>
						<h1 className='text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-accent via-primary to-accent bg-clip-text text-transparent'>
							Markaz boshqaruvi
						</h1>
						<p
				...
				<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8'>
					...
					<Card className='border-border'>
						...
						<CardContent>
							...
							<p className='text-[10px] sm:text-xs text-muted-foreground'>Rejalashtirilgan</p>
						</CardContent>
					</Card>
				</div>
									...
									notifications.slice(0, 6).map((n) => (
										<div
											...
											className={`flex items-start space-x-3 p-3 rounded-lg ${
												!n.isRead ? 'bg-muted/60' : 'bg-muted/20'
											}`}
										>
