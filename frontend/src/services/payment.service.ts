...
class PaymentService {
	...
	async previewStudentSettlement(data: StudentSettlementPreviewDto): Promise<APIResponse<StudentSettlementResult>> {
		try {
	...
	async closeStudentSettlement(data: StudentSettlementPreviewDto): Promise<APIResponse<StudentSettlementResult>> {
		try {
