				...
				<div className='text-center space-y-4'>
					...
					<div className='space-y-3'>
						<div className='p-4 bg-blue-50 rounded-lg border border-blue-200'>
							...
							<Button onClick={handleManualRegistration} className='w-full bg-blue-600 hover:bg-blue-700'>
								<MessageSquare className='mr-2 h-4 w-4' />@{TELEGRAM_BOT_USERNAME} botini ochish
						...
						<div className='p-4 bg-green-50 rounded-lg border border-green-200'>
							...
							<div className='bg-gray-800 text-green-400 p-3 rounded font-mono text-sm'>/start</div>
					...
					<div className='mt-6'>
						...
						<div className='flex justify-center'>
							<iframe
								src={`https://oauth.telegram.org/embed/${TELEGRAM_BOT_USERNAME}?origin=${encodeURIComponent(
									window.location.origin
								)}&size=large&userpic=false&radius=4`}
								width='200'
								height='36'
								frameBorder='0'
								scrolling='no'
