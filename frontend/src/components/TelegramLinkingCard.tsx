				...
				<div className='space-y-6'>
					...
					{unlinkedUsers.length > 0 ? (
							...
							<div className='space-y-4'>
								...
								<div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
									...
									<div className='space-y-2'>
										...
										<Select value={selectedLMSUser} onValueChange={setSelectedLMSUser}>
											<SelectTrigger>
						...
						<div className='text-center py-8'>
							...
							<h3 className='text-lg font-semibold text-foreground mb-2'>Hammasi ulandi!</h3>
							<p className='text-sm text-muted-foreground'>
					...
					<div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
						...
						<ul className='text-sm text-blue-700 space-y-1'>
							<li>1. Studentlar @EduOnePlatformbot ga /start yoki /register yuborishi kerak</li>
