...
const TelegramUserManagement: React.FC<TelegramUserManagementProps> = ({
  onSuccess,
  onError
}) => {
    ...
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Manage Telegram user connections and account linking
              </CardDescription>
            </div>
            <Button
              variant="outline"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Connect Telegram users with LMS accounts
          </CardDescription>
        </CardHeader>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Telegram users waiting to be linked to LMS accounts
                </CardDescription>
              </div>
              <div className="flex items-center space-x-2">
