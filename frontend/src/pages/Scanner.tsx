    ...
    const handleScan = async (imageFile?: File) => {
        ...
        try {
            ...
            if (response.data.variant_id) {
                ...
                const maxKey = Object.keys(response.data.answers).sort(
        ...
        <div className="max-w-4xl mx-auto">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Rasm yuklang yoki kamerani yoqing. Variant va javoblar avtomatik
                        aniqlanadi.
                    </CardDescription>
                </CardHeader>
                        ...
                        <div className="border rounded-md overflow-hidden bg-muted/20 aspect-[3/4] flex items-center justify-center relative">
                            {liveMode ? (
                                ...
                                <div className="text-xs text-muted-foreground px-3 text-center">
                                    Rasm tanlang yoki kamerani yoqing — bu yerda preview
                                    ko‘rinadi
                                </div>
                            )}
