      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Sizning hisob ma'lumotlaringiz
            </CardDescription>
          </CardHeader>
        ...
        <Alert>
          <AlertCircle className="h-4 w-4" />
          <AlertDescription>
            <strong>Eslatma:</strong> Telegram orqali ro'yxatdan o'tgan foydalanuvchilar uchun 
            standart parol <code className="bg-muted px-1 rounded">lms1234</code> belgilangan. 
            Xavfsizlik uchun parolni o'zgartirishni tavsiya etamiz.
          </AlertDescription>
        </Alert>
      </div>
    </div>
