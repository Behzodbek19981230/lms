            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="pt-4 border-t space-y-2">
                            ...
                            <div className="flex justify-between text-sm">
                                ...
                                <span
                                    className="font-medium">{questions.reduce((sum, q) => sum + q.points, 0)}</span>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="lg:col-span-2">
                    <CardHeader>
                        ...
                        <CardDescription>{testType === "open" ? "Variantli savol tuzish" : "Ochiq savol tuzish"}</CardDescription>
                    </CardHeader>
                    <CardContent>
                                            ...
                                            {currentQuestion.options?.map((option, index) => (
                                                <div key={index} className="flex items-center gap-2">
                                                    <RadioGroup
                                                        ...
                                                        onValueChange={(value) => updateCurrentQuestion("correctAnswer", Number(value))}
                                                    >
                                                    ...
                                                    <div className="flex items-start justify-between">
                                                        <div className="flex-1">
                                                            <div className="flex items-center gap-2 mb-2">
                                                                ...
                                                                <Badge
                                                                    variant="secondary">{question.points} ball</Badge>
                                                                {question.type === "multiple-choice" && (
                                                                    <Badge variant="outline">Ko'p variantli</Badge>
                                                                )}
                                                                {question.type === "true-false" && <Badge
                                                                    variant="outline">To'g'ri/Noto'g'ri</Badge>}
                                                                {question.type === "essay" &&
                                                            ...
                                                            {question.explanation && (
                                                                <div
                                                                    ...
                                                                    {selectedSubject?.hasFormulas ? (
                                                                        <LaTeXRenderer
                                                                            content={question.explanation} inline/>
                                                                    ) : (
