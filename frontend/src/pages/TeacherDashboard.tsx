        ...
        <div className='min-h-screen bg-gradient-subtle'>
            ...
            <div className='p-6'>
                ...
                <div className='mt-8'>
                    ...
                    {isLoading && <PageLoader title='Panel ma’lumotlari yuklanmoqda...' fullscreen={false} className='rounded-lg' />}
                                ...
                                >
                                    ...
                                    <CardContent>
                                        ...
                                        <div className='flex items-center justify-between text-xs text-muted-foreground'>
                                            ...
                                            <span
                                                className={`px-2 py-1 rounded-full text-xs ${subject.isActive
