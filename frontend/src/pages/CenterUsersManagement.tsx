        ...
        <div className="min-h-screen bg-gradient-subtle">
            ...
            <header className="bg-card border-b border-border p-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-3xl font-bold text-foreground">Markazlar va Foydalanuvchilar</h1>
                        <p className="text-muted-foreground">Barcha markazlardagi foydalanuvchilarni boshqarish</p>
                    </div>
                    <div className="flex items-center space-x-4">
                        <Button variant="outline" onClick={exportUsersData}>
                            <Download className="h-4 w-4 mr-2" />
                            Ma'lumotlarni yuklash
                        </Button>
                        <Button variant="outline" onClick={expandAllCenters}>
                            <ChevronDown className="h-4 w-4 mr-2" />
                            Barchasini ochish
                        </Button>
                        <Button variant="outline" onClick={collapseAllCenters}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">{centers.length} ta markazda</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-foreground">{totalTeachers}</div>
                            <p className="text-xs text-muted-foreground">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center space-x-4">
                                                <div className="flex space-x-2">
                                                    ...
                                                    <Badge variant="outline">
                                                        {center.users.filter(u => u.role === 'teacher').length} o'qituvchi
                                                    </Badge>
                                                    <Badge variant="outline">
